  ...
  angular.module('app.chart.ctrls', []).controller('chartCtrl', [
    '$scope', function($scope) {
      $scope.assertivenessReadWrite = {
        percent: $scope.assertivenessReadWritePercentual,
        options: {
          animate: {
            duration: 1000,
            enabled: true
    ...
    '$scope', '$http', function($scope, $http) {
      ...
      $scope.simpleData = [
        {
          datetime: "2014-08-26 23:07:45",
          value: 35680
        }, {
          datetime: "2014-08-26 23:07:55",
          value: 30210
        }, {
          datetime: "2014-08-26 23:08:05",
          value: 29569
        }, {
          datetime: "2014-08-26 23:08:15",
          value: 31560
        }, {
          datetime: "2014-08-26 23:08:25",
          value: 31800
        }
      ];
      $scope.comboData = [
    ...
    '$scope', '$http', 'dataService', function($scope, $http, dataService) {
      $scope.realtimeIndicator = 0;
      return dataService.getIndicators(function(dataResponse) {
        return $scope.realtimeIndicator = dataResponse.total_connections;
      });
    }
